...
const Lightfall = ({
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      const callIfFn = (obj: Program | Triangle | Mesh | Renderer | null, key: string) => {
        if (obj && typeof (obj as unknown as Record<string, unknown>)[key] === "function") {
          ((obj as unknown as Record<string, () => void>)[key]).call(obj);
        }
      };
